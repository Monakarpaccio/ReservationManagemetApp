...
- [Controllerメソッド一覧](docs/methods/controller_methods.md)
- [Serviceメソッド一覧](docs/methods/service_methods.md)
- [DAOメソッド一覧](docs/methods/dao_methods.md)
...
1. [Controllerメソッド](docs/methods/controller_methods.md)
2. [Serviceメソッド](docs/methods/service_methods.md)
3. [DAOメソッド](docs/methods/dao_methods.md)
...
`ReservationService`の4つのTransaction対象メソッドは、[Serviceメソッド一覧](docs/methods/service_methods.md)で処理順を細かく説明しています。
...
4. [Controllerメソッド一覧](docs/methods/controller_methods.md)を見ながらControllerを読む
5. 新規予約なら`ReservationController`から追う
6. 既存予約操作なら`ReservationListController`から追う
7. [Serviceメソッド一覧](docs/methods/service_methods.md)で業務ルールを確認する
8. Serviceが呼ぶDAOを[DAOメソッド一覧](docs/methods/dao_methods.md)で確認する
